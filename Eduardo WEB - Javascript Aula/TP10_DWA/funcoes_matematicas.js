    ...
    function roundToTenths(n2){
        ...
        function roundToHundredths(n3){
            ...
            function roundToThousandths(n4){
                ...
                form1.lervalores.value ="Arredondado para o proximo inteiro: " + n1+"\n"+"Arrendodado para o decimo mais proximo" +
                "(com um erro no DreamWeaver): "
                +n2+"\n" +"Arrendodado para o centesimo mais proximo: "+n3+"\n"+"Aproximado para o Milesimo mais proximo: "+n4;
                return;
